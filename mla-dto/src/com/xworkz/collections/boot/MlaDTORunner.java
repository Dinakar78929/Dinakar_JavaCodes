...
import com.xworkz.collections.dto.MlaDTO;
...
public class MlaDTORunner {
	...
	public static void main(String[] args) {
		...
		MlaDTO dto36 = new MlaDTO("Narasimhanayak (Rajugouda)", 60, "Shorapur", "IND", false, "male");
		...
		MlaDTO dto54 = new MlaDTO("DR. Sgivaraj Patil S", 60, "Raichuir", "IND", false, "male");
		...
		System.out.println("1.-------------------To find MLA age grater than 50-------------");
		mlaDetails.stream().filter(ref -> ref.getAge() > 50).collect(Collectors.toList())
				.forEach(element -> System.out.println(element));

		System.out.println("2.-------------------To find MLA age lesser than 50-------------");
		mlaDetails.stream().filter(ref -> ref.getAge() < 50).collect(Collectors.toList())
				.forEach(element -> System.out.println(element));

		System.out.println("3.-------------------To find Male MLAs-------------");
		mlaDetails.stream().filter(ref -> ref.getGender().equals("male")).collect(Collectors.toList())
				.forEach(element -> System.out.println(element));

		System.out.println("4.-------------------To find Female MLAs-------------");
		mlaDetails.stream().filter(ref -> ref.getGender().equals("female")).collect(Collectors.toList())
				.forEach(element -> System.out.println(element));

//		mlaDetails.stream().sorted((ref1, ref2) ->ref1.).collect(Collectors.toList()).forEach(element->System.out.println(element));
		System.out.println("5.------------------sorting party in assenting order------------------");
		...
		System.out.println("6.------------------sorting NAme in assenting order------------------");
		mlaDetails.stream().sorted((ref1, ref2) -> ref1.getName().compareTo(ref2.getName()))
				.collect(Collectors.toList()).forEach(element -> System.out.println(element));

		System.out.println("6.------------------sorting age in deccending order------------------");
		mlaDetails.stream().sorted((ref1, ref2) -> ref2.getAge().compareTo(ref1.getAge())).collect(Collectors.toList())
				.forEach(element -> System.out.println(element));

		System.out.println("7.------------------unique party------------------");
		mlaDetails.stream().map(ref -> ref.getParty()).distinct().collect(Collectors.toList())
				.forEach(element -> System.out.println(element));

		System.out.println("8.------------------Mla age >50 and party is BJP ------------------");
		mlaDetails.stream().filter(ref -> ref.getAge() > 50 && ref.getParty().contains("BJP"))
				.collect(Collectors.toList()).forEach(element -> System.out.println(element));

		System.out.println("9.-----------------mlas by each constituency ------------------");
		mlaDetails.stream().filter(ref -> ref.getConstituancy().equals("Hosadurga")).collect(Collectors.toList())
				.forEach(element -> System.out.println(element));

		System.out.println("10.-----------------get all MLA by party ------------------");
		mlaDetails.stream().filter(ref -> ref.getParty().equals("BJP")).collect(Collectors.toList())
				.forEach(element -> System.out.println(element));

		System.out.println("11.-----------------Independent MLAs ------------------");
		mlaDetails.stream().filter(ref -> ref.getParty().equals("IND")).collect(Collectors.toList())
				.forEach(element -> System.out.println(element));
	}
