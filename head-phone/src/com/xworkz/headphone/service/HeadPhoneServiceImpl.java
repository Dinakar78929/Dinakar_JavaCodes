	...
	public boolean validateAndThenSave(HeadPhoneDTO dto) {
		...
		if(dto!=null)
		{
			System.out.println("DTO is not null");
			 ...
			 if(ValidateUtil.validFlag(validBrand,validModelNo,validPrice,validBass,validColor,validWeight,validCustomerName,validInvoiceNo,validMgfDate,validWarrantyPeriod))
			 {
